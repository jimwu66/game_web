 ...
 * @author jimwu
 * 2022/07/18 v1.1
 * remove local storage score board
 */
...
function gameOver() {
  ...
  finishSound.play();
  /*
  1.1 refactor to storeScore
  checkHighScore(account.score);
   */
  storeScore(account.score);
...
/*
1.1 remove high score board , refactor checkHighScore()=>storeScore()
 */
