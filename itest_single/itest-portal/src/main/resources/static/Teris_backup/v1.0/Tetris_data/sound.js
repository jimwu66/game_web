...
let sound = new Sound(document.querySelector("#sound-div")),
    backgroundSound =  sound.create("Tetris_data/assets/sounds/Dungeon_Theme.mp3", "background_sound", true),
    movesSound = sound.create("Tetris_data/assets/sounds/moves.mp3", "moves_sound"),
    dropSound = sound.create("Tetris_data/assets/sounds/drop.mp3", "drop_sound"),
    pointsSound = sound.create("Tetris_data/assets/sounds/points.mp3", "points_sound"),
    finishSound = sound.create("Tetris_data/assets/sounds/finish.mp3", "finish_sound");;
sound.muteToggle();
sound.soundSetting();